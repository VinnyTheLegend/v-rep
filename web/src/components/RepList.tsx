...
function fakeData() {
  ...
  fakepartyupdate = {
    self: {name: "Vinny", cid: 1, citizenid: "asdbcvc"},
    party: {code: "xaTsAw", leader: "asdbcvc", members: [{name: "Vinny", cid: 1, citizenid: "asdbcvc"}, {name: "Spencer", cid: 2, citizenid: "askdekek"}, {name: "Gio", cid: 3, citizenid: "askdujds"}]}
  }
  debugData([
    {
      action: "updateParty",
  ...
  fakepartyupdate = {
    self: {name: "Vinny", cid: 1, citizenid: "asdbcvc"},
    party: {code: "xaTsAw", leader: "asdbcvc", members: [{name: "Vinny", cid: 1, citizenid: "asdbcvc"}, {name: "Spencer", cid: 2, citizenid: "askdekek"}, {name: "Gio", cid: 3, citizenid: "askdujds"}, {name: "Nimmy", cid: 4, citizenid: "cvsjujds"}]}
  }
  debugData([
    {
      action: "updateParty",
